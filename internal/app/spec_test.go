...
func TestSpecDescribesTheContract(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"/api/models/{id}/parent", "put", "204", []string{"401", "404", "409", "422"}},
		{"/api/models/bulk/tags", "post", "204", []string{"401", "404", "409", "422"}},
		{"/api/models/bulk/category", "post", "204", []string{"401", "404", "409", "422"}},
		{"/api/models/bulk/collection", "post", "204", []string{"401", "404", "409", "422"}},
		{"/api/models/bulk/delete-preview", "post", "200", []string{"401", "404", "422"}},
		{"/api/models/bulk/delete", "post", "204", []string{"401", "404", "409", "422"}},
